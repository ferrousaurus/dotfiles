...
- Related: [render-no-nested-ternaries.md](../../react/rules/render-no-nested-ternaries.md)
- Related: [render-conditional-patterns.md](../../react/rules/render-conditional-patterns.md)
