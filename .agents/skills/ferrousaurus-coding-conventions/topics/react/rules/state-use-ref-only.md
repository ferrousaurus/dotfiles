...
function Stopwatch() {
  ...
  function handleStart() {
    intervalRef.current = setInterval(() => setElapsed((elapsed: number) => elapsed + 1), 1000);
  }
...
- Related: [state-usereducer-nontrivial.md](../../react/rules/state-usereducer-nontrivial.md)
- Related: [hook-custom-conventions.md](../../react/rules/hook-custom-conventions.md)
